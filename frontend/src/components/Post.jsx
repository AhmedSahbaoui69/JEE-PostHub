        ...
        <div className="flex items-start gap-2.5 pt-8">
            ...
            <div className="flex flex-col w-full leading-1.5 p-4 border-gray-200 bg-gray-100 rounded dark:bg-gray-700">
                ...
                <div className="flex flex-row items-center justify-between h-12">
                    <div className="flex flex-row items-center">
                        <Button className="p-0 w-9" color="success" pill>
                            <BiSolidUpvote/>
                        </Button>
                        <Button className="mx-2 p-0 w-9" color="failure" pill>
                            <BiSolidDownvote/>
                        </Button>
                    ...
                    <div>
                        <Dropdown label="" dismissOnClick={false}
                                  renderTrigger={() => <button id="dropdownMenuIconButton" data-dropdown-toggle="dropdownDots"
                                                               data-dropdown-placement="bottom-start"
                                                               className="inline-flex self-center items-center p-2 text-sm font-medium text-center text-gray-900 bg-white rounded-lg hover:bg-gray-100 focus:ring-4 focus:outline-none dark:text-white focus:ring-gray-50 dark:bg-gray-900 dark:hover:bg-gray-800 dark:focus:ring-gray-600" type="button">
                                      <BsThreeDots/>
                                  </button>}>
                            <Dropdown.Item>
